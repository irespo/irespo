...
**CONTRACT CONTENT.** The contract is meant to store the information about users’ tokens in case when the user does not have his EOS account. 

## CLAUSE NAME: Acknowledgment 

**ACKNOWLEDGMENT.** The users acknowledge that the information about their tokens will be stored in an escrow account managed by IRESPO. 
